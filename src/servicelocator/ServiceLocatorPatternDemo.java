...
public class ServiceLocatorPatternDemo {
    public static void main(String[] args) {
        Service service = ServiceLocator.getService(Services.Service1);
        service.execute();

        service = ServiceLocator.getService(Services.Service2);
        service.execute();

        service = ServiceLocator.getService(Services.Service1);
        service.execute();
